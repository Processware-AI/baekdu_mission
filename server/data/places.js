...
export const PLACES = [
  ...
  { slug: 'yanji-arrival', day: 1, seq: 3, time: '17:25', title: '연길 국제공항 도착',
    ...
    desc: '입국심사 → 수하물 → 현지 가이드 미팅 → 호차별 차량 탑승 후 석식장소로 이동.',
    tip: '"인천상공회의소 산악회" 피켓 앞에서 한 컷!' },
  { slug: 'yanji-dinner', day: 1, seq: 4, time: '18:30', title: '연길 석식 (불고기 전골)',
    area: '연길', emoji: '🍲', boost: 1,
    desc: '공항 도착 후 연길에서 첫 현지 석식. 식사를 마치고 이도백하로 이동합니다.',
    tip: '건배 장면은 영상으로! 소리까지 살아있는 컷이 좋습니다.' },
  { slug: 'paradise-hotel', day: 1, seq: 5, time: '22:00', title: '이도 파라다이스 호텔',
    area: '이도백하', emoji: '🏨', boost: 1,
    desc: '석식 후 이도백하로 이동(약 2시간). 1·2일차 숙소 (준5성급). 체크인 및 휴식.',
